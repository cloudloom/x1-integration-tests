...
import com.tracebucket.x1.organization.partner.integration.test.builder.OrganizationBuilder;
...
/*        Set<DefaultAddress> addresses = new HashSet<DefaultAddress>(0);
        ...
        DefaultOrganization organization = OrganizationBuilder.anOrganizationBuilder()
                //.withName("ABC Bank")
