 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"com.tracebucket.x1.**.api.repository.jpa", "com.tracebucket.x1.organization.partner.integration.test.repository.jpa"}, repositoryFactoryBeanClass = CustomRepositoryFactoryBean.class)
@EntityScan(basePackages = {"com.tracebucket.x1.**.api.domain", "com.tracebucket.x1.dictionary.api.domain.jpa.impl", "com.tracebucket.x1.organization.partner.integration.test.domain"})
@PropertySource(value = "classpath:jpa.properties")
@EnableTransactionManagement(proxyTargetClass = true)
@EnableJpaAuditing
public class JPAConfiguration {
    private static final Logger log = LoggerFactory.getLogger(com.tracebucket.x1.partner.api.autoconfig.JPAConfiguration.class);
